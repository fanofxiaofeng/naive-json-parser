...
public class CharacterParserTest {
    ...
    public void testCaseOne() {
        RandomCharacterGenerator characterGenerator = new RandomCharacterGenerator();
    ...
    public void testCaseTwo() {
        ...
        RandomHexGenerator randomHexGenerator = new RandomHexGenerator();
        for (int i = 0; i < 100; i++) {
            List<String> strings = IntStream.range(0, 4).mapToObj(n -> randomHexGenerator.generateRandomHex()).toList();
