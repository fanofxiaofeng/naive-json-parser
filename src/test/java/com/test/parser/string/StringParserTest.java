...
public class StringParserTest extends TestBase {
    ...
    public void testQuotationMark() {
        Stream.of(
                "\"\\\"\"", // "\""
                "\"\\u0022\""
        ).forEach(value -> validate(value, com.study.model.string.String.class));
    }
    ...
    public void testHex() {
        IntConsumer validateCodePoint = (cp) -> {
            ...
            Stream.of(lowerHex, upperHex).forEach(h -> {
                ...
                validate(fullForm, com.study.model.string.String.class);
    ...
    public void test() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            validate(joiner.toString(), com.study.model.string.String.class);
        }
    }
